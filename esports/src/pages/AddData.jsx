...
function AddData() {
  ...
  const handlePlayerSubmit = async (e) => {
    ...
    console.log(playerFormData)
    axios.post("http://localhost:8080/add_player_data", {
      id: playerFormData
    })
    setStatus(1);
  };
  ...
  return (
    <div className='main-div'>
      ...
      <div className={`conditional-com-1 ${status === 0 ? 'show' : 'hide'}`}>
        <form onSubmit={handlePlayerSubmit} className='add-data-form'>
          <span className='add-data-form-container-1'>
            <div className="add-data-form-text">
              <label htmlFor="pname" className='add-data-header'>Player Name</label>
              <label htmlFor="dob" className='add-data-header'>Date Of Birth</label>
              <label htmlFor="sex" className='add-data-header'>Sex</label>
              <label htmlFor="origin" className='add-data-header'>Country of Origin</label>
              <label htmlFor="desc" className='add-data-header'>Description</label>
            </div>
      ...
      <div className={`conditional-com-2 ${status === 0 ? 'show' : 'hide'}`}>
        <form onSubmit={handleTeamSubmit} className='add-data-form'>
          <span className='add-data-form-container-2'>
            <div className="add-data-form-text">
              <label htmlFor="name" className='add-data-header'>Team Name</label>
              <label htmlFor="dob" className='add-data-header'>Date Of Birth</label>
              <label htmlFor="sex" className='add-data-header'>Sex</label>
              <label htmlFor="desc" className='add-data-header'>Description</label>
            </div>
