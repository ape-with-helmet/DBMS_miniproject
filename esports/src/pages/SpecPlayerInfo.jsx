...
const SpecPlayerInfo = () => {
    ...
    useEffect(() => {
        const getTeamData = async (download) => {
            try {
                const response = await axios.post("https://690c-2405-201-d00f-608c-4e4b-9e5b-b74a-27ab.ngrok-free.app/fetch_player_details", {
                    id: download
                });
                            ...
                            <div className='spec-player-image-container'>
                                {
                                    prod.photo != null ?
                                        ...
                                        :
                                        <img src='https://static.vecteezy.com/system/resources/thumbnails/010/884/730/small_2x/owl-head-mascot-team-logo-png.png' alt='yada' className='spec-player-image' />
                                }
                            </div>
