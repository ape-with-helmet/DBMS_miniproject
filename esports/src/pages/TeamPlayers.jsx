...
const TeamPlayers = () => {
    ...
    useEffect(() => {
        const getTeamData = async (download) => {
            try {
                const response = await axios.post("https://690c-2405-201-d00f-608c-4e4b-9e5b-b74a-27ab.ngrok-free.app/fetch_team_details", {
                    id: download
                });
    ...
    useEffect(() => {
        const getSpnsorData = async (download) => {
            try {
                const sponsor_response = await axios.post("https://690c-2405-201-d00f-608c-4e4b-9e5b-b74a-27ab.ngrok-free.app/sponsor_details", {
                    id: download
                });
    ...
    useEffect(() => {
        const getMerchData = async (download) => {
            try {
                const merch_response = await axios.post("https://690c-2405-201-d00f-608c-4e4b-9e5b-b74a-27ab.ngrok-free.app/fetch_merch", {
                    id: download
                });
    ...
    function buymerch(x, y) {
        axios.post("https://690c-2405-201-d00f-608c-4e4b-9e5b-b74a-27ab.ngrok-free.app/buy_merch", {
            teamname: x,
            merch_name: y
        });
    ...
    function sellmerch(x, y) {
        axios.post("https://690c-2405-201-d00f-608c-4e4b-9e5b-b74a-27ab.ngrok-free.app/cancel_merch", {
            teamname: x,
            merch_name: y
        });
    }
